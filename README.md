...
```javascript
dtypes = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-dtypes@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/strided-dtypes@umd/bundle.js"></script>
```
